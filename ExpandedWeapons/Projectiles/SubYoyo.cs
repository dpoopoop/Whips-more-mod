...
{
	public class SubYoyo : ModProjectile
	{
		public int yoyo;
		...
		public override void AI()
		{
			for (int i = 0; i < 200; i++) //this code below handles the aiming and shooting of the minion.
            {
				...
				{
				Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, shootToX, shootToY, mod.ProjectileType("SubBeam"), damage, 0f, Main.myPlayer, 0f, 0f); 
