...
{
	public class SnowstormCloud : ModProjectile
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Snowstorm Cloud");
		...
		public override void AI()
		{
			...
			Projectile.NewProjectile(projectile.Center.X + MathHelper.Lerp(-16f, 16f, (float)Main.rand.NextDouble()), projectile.Center.Y + 16, 0, 6, 239, damage, 0f, Main.myPlayer, 0f, 0f);
			Projectile.NewProjectile(projectile.Center.X + MathHelper.Lerp(-16f, 16f, (float)Main.rand.NextDouble()), projectile.Center.Y + 16, MathHelper.Lerp(-3f, 3f, (float)Main.rand.NextDouble()), 4, mod.ProjectileType("Snowfall"), damage, 0f, Main.myPlayer, 0f, 0f); 
			}
