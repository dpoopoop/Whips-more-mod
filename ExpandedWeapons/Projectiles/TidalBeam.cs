...
namespace ExpandedWeapons.Projectiles
{
	public class TidalBeam : ModProjectile
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Tidal Beam");     //The English name of the projectile
		...
		public override void AI()
        {
			...
			for (int i = 0; i < 1; i++)
		{
			Dust dust = Dust.NewDustDirect(projectile.position, projectile.width, projectile.height, 20, projectile.velocity.X, projectile.velocity.Y, 0, default, 1f);
			dust.noGravity = true;
			dust.velocity *= 0.3f;
		}
		}
