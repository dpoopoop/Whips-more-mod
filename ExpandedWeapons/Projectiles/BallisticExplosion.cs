...
{
    public class BallisticExplosion : ModProjectile
    {
        public override void SetStaticDefaults() {
            // The English name of this projectile.
            DisplayName.SetDefault("Ballistic Explosion");
        ...
        public override void AI() {
            ...
            for (int i = 0; i < dusts; i++) {
                ...
                if (Main.rand.NextBool(3)) {
                    ...
                    Dust dust1 = Dust.NewDustPerfect(projectile.Center, DustID.Smoke, velocity, 173, Color.White, 1.5f);
