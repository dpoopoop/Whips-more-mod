...
namespace ExpandedWeapons.Projectiles.Minions
{
	public class FireBall : ModProjectile
	{
		...
		public override void AI()
        {
            ...
            var dust = Dust.NewDustDirect(projectile.position, projectile.width, projectile.height, 6, projectile.velocity.X * 0.4f, projectile.velocity.Y * 0.4f, 100, default, 2f); //create a dust trail.
			dust.noGravity = true;
		}
		public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)                
        {
            target.AddBuff(24, 5 * 60); //apply frostburn (ID 44) to the target for 5 seconds.
		}
