...
{
    public class LightningShot : ModProjectile
    {
         ...
         public override void AI()
        {
            ...
            if (projectile.localAI[0] > 3f) 
            {
                for (int i = 0; i < 4; i++)
                {
                    ...
                    var dust = Dust.NewDustDirect(projectile.position, projectile.width, projectile.height, 169, 0, 0, 100, default, 1f);
			        dust.noGravity = true;
