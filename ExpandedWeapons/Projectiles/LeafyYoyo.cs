...
{
	public class LeafyYoyo : ModProjectile
	{
		...
		public override void PostAI() 
		{
			...
			if (Main.rand.NextBool()) 
			{
				...
				if (leafCooldown == 15)
				{
			Projectile.NewProjectile(projectile.position.X, projectile.position.Y, MathHelper.Lerp(-3f, 3f, (float)Main.rand.NextDouble()), MathHelper.Lerp(-5f, 5, (float)Main.rand.NextDouble()), 206, damage / 3, 0f, Main.myPlayer);
			Projectile.NewProjectile(projectile.position.X, projectile.position.Y, MathHelper.Lerp(-3f, 3f, (float)Main.rand.NextDouble()), MathHelper.Lerp(-5f, 5, (float)Main.rand.NextDouble()), 206, damage / 3, 0f, Main.myPlayer);
			Projectile.NewProjectile(projectile.position.X, projectile.position.Y, MathHelper.Lerp(-3f, 3f, (float)Main.rand.NextDouble()), MathHelper.Lerp(-5f, 5, (float)Main.rand.NextDouble()), 206, damage / 3, 0f, Main.myPlayer);
			leafCooldown = 0;
			    }
