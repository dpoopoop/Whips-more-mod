...
namespace ExpandedWeapons.Projectiles
{
	public class IchorFlames : ModProjectile
	{
		...
		{
			DisplayName.SetDefault("Ichor Flames"); // The English name of the projectile
		}
		...
		public override void AI()
		{
            ...
            for (int i = 0; i < dusts; i++) {
				Dust dust = Dust.NewDustDirect(projectile.position, projectile.width, projectile.height, 170, projectile.velocity.X * 0.2f, projectile.velocity.Y * 0.2f, 100);
