...
{
    public class BoneSpinnerProj : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, 31);  //this is the dust that this projectile will spawn
