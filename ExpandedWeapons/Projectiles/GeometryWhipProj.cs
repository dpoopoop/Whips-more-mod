...
{
    public class GeometryWhipProj : ModProjectile
    {
        ...
        public override void SetStaticDefaults() {
            DisplayName.SetDefault("Geometry Whip Projectile");
        }
        ...
        public override void AI() {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                Dust dust1 = Dust.NewDustPerfect(chainHeadPosition, 111, velocity, 150, Color.White, 1.5f);
            ...
            public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)                
        {
            ...
            player.AddBuff(ModContent.BuffType<Buffs.Tag>(), 3 * 60);
