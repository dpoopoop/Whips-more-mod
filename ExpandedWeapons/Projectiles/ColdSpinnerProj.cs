...
{
    public class ColdSpinnerProj : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                var dust = Dust.NewDustDirect(target.position, target.width, target.height, 111);
                dust.scale = 2f;
                dust.noGravity = true;
        ...
        public override void AI()
        {
            ...
            int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, 111);  //this is the dust that this projectile will spawn
