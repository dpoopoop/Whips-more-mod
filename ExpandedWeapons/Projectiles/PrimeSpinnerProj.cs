...
{
    public class PrimeSpinnerProj : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Prime Spinner");
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                var dust = Dust.NewDustDirect(target.position, target.width, target.height, 63);
                dust.scale = 2f;
                dust.noGravity = true;
        ...
        public override void AI()
        {
            ...
            int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, 63);  //this is the dust that this projectile will spawn
