...
{
	public class IcicleYoyo : ModProjectile
	{
		public int yoyo3;
		...
		public override void AI()
		{
			for (int i = 0; i < 200; i++) //this code below handles the aiming and shooting of the minion.
            {
				...
				{
				Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, shootToX, shootToY, 337, damage / 2, 0f, Main.myPlayer, 0f, 0f); 
