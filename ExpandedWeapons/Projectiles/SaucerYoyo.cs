...
{
	public class SaucerYoyo : ModProjectile
	{
		public int yoyo4;
		...
		public override void SetStaticDefaults() {
			...
			ProjectileID.Sets.YoyosMaximumRange[projectile.type] = 460f;
		...
		public override void AI()
		{
			for (int i = 0; i < 200; i++) //this code below handles the aiming and shooting of the minion.
            {
                ...
                if (distance < 240f && !target.friendly && target.active && target.CanBeChasedBy()) //range is 400 pixels. 
                {
                    if (yoyo4 > 5000)
                    {
				...
				{
				Projectile.NewProjectile(projectile.Center.X, projectile.Center.Y, shootToX, shootToY, mod.ProjectileType("BetterPurpleLaser"), damage / 2, 0f, Main.myPlayer, 0f, 0f); 
