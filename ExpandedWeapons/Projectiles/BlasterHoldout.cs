...
{
	public class BlasterHoldout : ModProjectile
	{
		...
		public const float MaxCharge = 320f;
		...
		private const float AimResponsiveness = 0.065f;
		...
		{
			DisplayName.SetDefault("Blaster Holdout");
		...
		private void FireBeams()
		{
			...
			for (int b = 0; b < NumBeams; ++b) {
				Projectile.NewProjectile(projectile.Center, beamVelocity, ModContent.ProjectileType<BlasterBeam>(), damage, knockback, projectile.owner, b, uuid);
			}
