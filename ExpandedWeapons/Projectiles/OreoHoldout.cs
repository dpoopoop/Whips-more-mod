...
{
	public class OreoHoldout : ModProjectile
	{
		...
		{
			DisplayName.SetDefault("Oreo Holdout");
		...
		private void FireBeams()
		{
			...
			for (int b = 0; b < NumBeams; ++b) {
				Projectile.NewProjectile(projectile.Center, beamVelocity, ModContent.ProjectileType<OreoBeamMk2>(), damage, knockback, projectile.owner, b, uuid);
			}
