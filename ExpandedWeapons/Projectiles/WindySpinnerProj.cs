...
{
    public class WindySpinnerProj : ModProjectile
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Windy Spinner");
        ...
        public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                var dust = Dust.NewDustDirect(target.position, target.width, target.height, 91);
                dust.scale = 2f;
                dust.noGravity = true;
        ...
        public override void AI()
        {
            ...
            int dust = Dust.NewDust(projectile.position, projectile.width, projectile.height, 91);  //this is the dust that this projectile will spawn
            Main.dust[dust].velocity /= 1f;
            Main.dust[dust].scale = 2f;
            Main.dust[dust].noGravity = true;
            projectile.usesLocalNPCImmunity = true;
            projectile.localNPCHitCooldown = 10; //hit speed (how fast it attacks)
        }
