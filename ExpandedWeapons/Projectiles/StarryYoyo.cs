...
{
	public class StarryYoyo : ModProjectile
	{
		public int starDown;
		...
		public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)                
        {
			...
			if (starDown == 7)
			{
				...
				Projectile.NewProjectile(target.position.X, target.position.Y - 200, 0, 30, ModContent.ProjectileType<YoyoStar>(), damage * 2, 0, player.whoAmI);
				starDown = 0;
			}
		}
