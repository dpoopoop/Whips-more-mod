...
{
	public class IchorShowerCloud : ModProjectile
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Ichor Shower Cloud");
		...
		public override void AI()
		{
			...
			Projectile.NewProjectile(projectile.Center.X + MathHelper.Lerp(-16f, 16f, (float)Main.rand.NextDouble()), projectile.Center.Y + 16, 0, 6,  mod.ProjectileType("Ichorrain"), damage, 1f, Main.myPlayer, 0f, 0f); 
			}
