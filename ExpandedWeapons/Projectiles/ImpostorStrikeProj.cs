...
{
    public class ImpostorStrikeProj : ModProjectile
    {
        ...
        public override void SetStaticDefaults() {
            DisplayName.SetDefault("Impostor Strike Projectile");
        }
        ...
        public override void AI() {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                Dust dust1 = Dust.NewDustPerfect(chainHeadPosition, 91, velocity, 150, Color.White, 1f);
            ...
            public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)                
        {
            ...
            player.AddBuff(ModContent.BuffType<Buffs.ImpostorCooldown>(), 60 * 60);
