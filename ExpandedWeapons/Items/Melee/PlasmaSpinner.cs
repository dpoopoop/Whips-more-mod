...
{
	public class PlasmaSpinner : ModItem
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Plasma Spinner"); 
			Tooltip.SetDefault("'This plasma is explosive. And poisonous'");
		...
		public override void SetDefaults() 
		{
           ...
           item.useTurn = true;
            ...
            item.knockBack = 6f;
            item.shootSpeed = 1f;
            item.shoot = mod.ProjectileType("PlasmaSpinnerProj");
            item.noMelee = true; 
