...
{
	public class PrimeSpinner : ModItem
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Prime Spinner"); 
			Tooltip.SetDefault("'Using skeletron prime's arms as a spinner is a great idea'");
		...
		public override void SetDefaults() 
		{
           ...
           item.useTurn = true;
            ...
            item.knockBack = 4f;
            item.shootSpeed = 1f;
            item.shoot = mod.ProjectileType("PrimeSpinnerProj");
            item.noMelee = true; 
        ...
        {
            Texture2D texture = mod.GetTexture("Items/Melee/PrimeSpinner");
