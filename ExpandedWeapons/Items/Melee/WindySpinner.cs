...
{
	public class WindySpinner : ModItem
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Windy Spinner"); 
			Tooltip.SetDefault("'Spinning with the air'");
		...
		public override void SetDefaults() 
		{
           ...
           item.useTurn = true;
            ...
            item.knockBack = 5f;
            item.shootSpeed = 1f;
            item.shoot = mod.ProjectileType("WindySpinnerProj");
            item.noMelee = true; 
        ...
        {
            Texture2D texture = mod.GetTexture("Items/Melee/WindySpinner");
