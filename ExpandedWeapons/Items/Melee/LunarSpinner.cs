...
{
	public class LunarSpinner : ModItem
	{
		public override void SetStaticDefaults() 
		{
			DisplayName.SetDefault("Lunar Spinner"); 
			Tooltip.SetDefault("'Spinning with all the power from the pillars'");
		...
		public override void SetDefaults() 
		{
           ...
           item.useTurn = true;
            ...
            item.knockBack = 7f;
            item.shootSpeed = 1f;
            item.shoot = mod.ProjectileType("LunarSpinnerProj");
            item.noMelee = true; 
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(3458, 16);
            recipe.AddIngredient(3456, 16);
            recipe.AddIngredient(3459, 16);
        ...
        {
            Texture2D texture = mod.GetTexture("Items/Melee/PlasmaSpinner");
