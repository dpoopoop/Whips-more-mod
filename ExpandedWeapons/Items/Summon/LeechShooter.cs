...
{
	public class LeechShooter : ModItem
	{
		public override void SetStaticDefaults() {
			Tooltip.SetDefault("Shoots leechs that can heal the player");
		}
		...
		public override void SetDefaults() {
			...
			item.UseSound = SoundID.Item95; // The sound that this item plays when used.
			item.autoReuse = true; // if you can hold click to automatically use it again
			item.shoot = ModContent.ProjectileType<LeechShooterProj>();
