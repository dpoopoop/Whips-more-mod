...
namespace ExpandedWeapons.Items.Summon
{
    public class SnowflakeStaff : ModItem
    {
		public override void SetStaticDefaults() {
			Tooltip.SetDefault(@"Summons a snowflake over your head
'Only one snowflake can be summoned at a time'");
		}
        public override void SetDefaults()
        { 
            item.mana = 15; //how much mana it uses.
			item.damage = 95; //the damage of the weapon. 
            ...
            item.buffType = ModContent.BuffType<Buffs.Snowflake>();
        }
        ...
        public override void AddRecipes() {
			...
			recipe.AddIngredient(ModContent.ItemType<IceCrystalRod>(), 1);
