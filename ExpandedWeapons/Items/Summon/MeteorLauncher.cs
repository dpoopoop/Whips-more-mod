...
{
	public class MeteorLauncher : ModItem
	{
		public override void SetStaticDefaults() {
			Tooltip.SetDefault("Shoots tiny meteor heads that burn enemies");
		}
		...
		public override void SetDefaults() {
			...
			item.shoot = ModContent.ProjectileType<MeteorLauncherProj>();
