...
{
	public class SoulEaterGun : ModItem
	{
		public override void SetStaticDefaults() {
			Tooltip.SetDefault("Shoots soul blasts that can burn with cursed flames");
		}
		...
		public override void SetDefaults() {
			...
			item.UseSound = SoundID.Item33; // The sound that this item plays when used.
			item.autoReuse = true; // if you can hold click to automatically use it again
			item.shoot = ModContent.ProjectileType<SoulEaterGunProj>();
