...
{
    public class FlamingBallStaff : ModItem
    {
		public override void SetStaticDefaults() {
			Tooltip.SetDefault(@"Summons a flaming ball over your head
'Only one flaming ball can be summoned at a time'");
		}
        public override void SetDefaults()
        { 
            item.mana = 12; //how much mana it uses.
			item.damage = 32; //the damage of the weapon. 
            ...
            item.buffType = ModContent.BuffType<Buffs.FlamingBall>();
        }
