...
{
	public class CrimeraGun : ModItem
	{
		public override void SetStaticDefaults() {
			Tooltip.SetDefault("Shoots blood blasts that can put ichor on enemies");
		}
		...
		public override void SetDefaults() {
			...
			item.shoot = ModContent.ProjectileType<CrimeraGunProj>();
