...
namespace ExpandedWeapons.Items.Ranged
{
	...
	public class FlamingSkull : ModItem
	{
		public override void SetStaticDefaults(){
			Tooltip.SetDefault(@"Shoots a spread of green flames.
'A magical flamethrower, yet deals ranged damage'");
		}
		...
		public override void SetDefaults()
		{
			...
			item.shootSpeed = 5f; // How fast the flames will travel. Vanilla Flamethrower uses 7f and consequentially has less reach. item.shootSpeed and projectile.timeLeft together control the range.
        ...
        {
			Vector2 muzzleOffset = Vector2.Normalize(new Vector2(speedX, speedY)) * 64f; //This gets the direction of the flame projectile, makes its length to 1 by normalizing it. It then multiplies it by 54 (the item width) to get the position of the tip of the flamethrower.
