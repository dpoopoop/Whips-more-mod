...
{
	public class MushroomBlaster : ModItem
	{
		public override void SetStaticDefaults() {
			Tooltip.SetDefault("'Also shoots mushrooms'");
		}
		...
		public override void AddRecipes() {
			...
			recipe.AddIngredient(ModContent.ItemType<Items.Ranged.DoubleBarrelShotgun>(), 1);
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			Projectile.NewProjectile(position.X, position.Y, speedX, speedY, ModContent.ProjectileType<BlastMushroom>(), damage * 2, knockBack, player.whoAmI);
