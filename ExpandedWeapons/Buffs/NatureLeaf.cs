...
{
    public class NatureLeaf : ModBuff
	{
		public override void SetDefaults() {
			DisplayName.SetDefault("Nature Leaf");
			Description.SetDefault("The nature leaf is hovering above your head");
			...
			{
			if (player.ownedProjectileCounts[ModContent.ProjectileType<Projectiles.Minions.NatureLeaf>()] > 0) {
