...
{
    public class FlamingBall : ModBuff
	{
		public override void SetDefaults() {
			DisplayName.SetDefault("Flaming Ball");
			Description.SetDefault("The flaming ball is hovering above your head");
			...
			{
			if (player.ownedProjectileCounts[ModContent.ProjectileType<Projectiles.Minions.FlamingBall>()] > 0) {
