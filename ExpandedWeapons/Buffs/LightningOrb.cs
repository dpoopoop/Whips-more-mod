...
{
    public class LightningOrb : ModBuff
	{
		public override void SetDefaults() {
			DisplayName.SetDefault("Lightning Orb");
			Description.SetDefault("The lightning orb is hovering above your head");
			...
			{
			if (player.ownedProjectileCounts[ModContent.ProjectileType<Projectiles.Minions.LightningOrb>()] > 0) {
