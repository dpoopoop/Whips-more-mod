...
{
    public class IceCrystal : ModBuff
	{
		public override void SetDefaults() {
			DisplayName.SetDefault("Ice Crystal");
			Description.SetDefault("The ice crystal is hovering above your head");
			...
			{
			if (player.ownedProjectileCounts[ModContent.ProjectileType<Projectiles.Minions.IceCrystal>()] > 0) {
