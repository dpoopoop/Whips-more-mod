...
{
	public class ChainWhipProj : ModProjectile
	{
		// chain texture
		private const string ChainTexturePath = "SummonWhips/Gores/ChainWhipChn";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Chain Whip Projectile"); 
		}
