...
{
	public class WhipOfLightProj : ModProjectile
	{
		// chain texture
		private const string ChainTexturePath = "SummonWhips/Gores/WhipOfLightChn";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Whip of Light Projectile"); 
		}
		...
		public override void AI()
		{
			...
			if (projectile.ai[0] == 0f) {
				...
				float maxStretchLength = 94f; // make this number 6 less than max range
