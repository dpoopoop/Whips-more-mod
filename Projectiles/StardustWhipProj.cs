...
namespace SummonWhips.Projectiles
{
	...
	{
		// chain texture
		private const string ChainTexturePath = "SummonWhips/Gores/StardustWhipChn";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Stardust Whip Projectile"); 
		}
		...
		{
			// PARTICLES optional
			var dust = Dust.NewDustDirect(projectile.position, projectile.width, projectile.height, 111, projectile.velocity.X * 0.4f, projectile.velocity.Y * 0.4f, 100, default, 1.5f);
			dust.noGravity = true;
			dust.velocity /= 2f;
			...
			if (projectile.ai[0] == 0f) {
				...
				float elasticFactorB = 5f / player.meleeSpeed;
				float maxStretchLength = 174f; // make this number 6 less than max range
