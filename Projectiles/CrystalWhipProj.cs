...
{
	public class CrystalWhipProj : ModProjectile
	{
		// chain texture
		private const string ChainTexturePath = "SummonWhips/Gores/CrystalWhipChn";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Crystal Whip Projectile"); 
		}
		...
		{
			// PARTICLES optional
			var dust = Dust.NewDustDirect(projectile.position, projectile.width, projectile.height, 179, projectile.velocity.X * 0.4f, projectile.velocity.Y * 0.4f, 100, default, 1.5f);
			dust.noGravity = true;
			dust.velocity /= 2f;
