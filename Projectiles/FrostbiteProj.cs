...
namespace SummonWhips.Projectiles
{
	...
	{
		// chain texture
		private const string ChainTexturePath = "SummonWhips/Gores/FrostbiteChn";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Frostbite Projectile"); 
		}
		...
		{
			// PARTICLES
			var dust = Dust.NewDustDirect(projectile.position, projectile.width, projectile.height, 180, projectile.velocity.X * 0.4f, projectile.velocity.Y * 0.4f, 100, default, 1.5f);
			dust.noGravity = true;
			dust.velocity /= 2f;
