...
{
	public class TheTongueProj : ModProjectile
	{
		// chain texture
		private const string ChainTexturePath = "SummonWhips/Gores/TheTongueChn";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("The Tongue Projectile"); 
		}
		...
		public override void AI()
		{
			...
			if (projectile.ai[0] == 0f) {
				...
				float maxStretchLength = 74f; // make this number 6 less than max range
