...
{
	public class WormWhipProj : ModProjectile
	{
		// chain texture
		private const string ChainTexturePath = "SummonWhips/Gores/WormWhipChn";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Worm Whip Projectile"); 
		}
		...
		public override void AI()
		{
			...
			if (projectile.ai[0] == 0f) {
				...
				float maxStretchLength = 106f; // make this number 6 less than max range
