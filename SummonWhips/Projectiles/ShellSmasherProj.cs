...
{
	public class ShellSmasherProj : ModProjectile
	{
		// chain texture
		private const string ChainTexturePath = "SummonWhips/Gores/ShellSmasherChn";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Shell Smasher Projectile"); 
		}
		...
		{
			// PARTICLES optional
			//var dust = Dust.NewDustDirect(projectile.position, projectile.width, projectile.height, 177, projectile.velocity.X * 0.4f, projectile.velocity.Y * 0.4f, 100, default, 1.5f);
			//dust.noGravity = true;
			//dust.velocity /= 2f;
			...
			if (projectile.ai[0] == 0f) {
				...
				float maxStretchLength = 114f; // make this number 6 less than max range
