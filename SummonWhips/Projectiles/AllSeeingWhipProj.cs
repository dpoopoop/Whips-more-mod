...
{
    public class AllSeeingWhipProj : ModProjectile
    {
        ...
        public override void SetStaticDefaults() {
            DisplayName.SetDefault("All Seeing Whip Projectile");
        }
        ...
        public override void AI() {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                Dust dust1 = Dust.NewDustPerfect(chainHeadPosition, 60, velocity, 150, Color.White, 1.5f);
