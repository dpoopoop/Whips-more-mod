...
{
	public class MorningStarProj : ModProjectile
	{
		// chain texture
		private const string ChainTexturePath = "SummonWhips/Gores/MorningStarChn";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Morning Star Projectile"); 
		}
