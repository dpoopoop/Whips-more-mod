...
{
	public class NewMelee : ModProjectile
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("New Melee");
		}
		...
		public override void AI() {
			...
			if (!projOwner.frozen) {
				...
				{
					movementFactor = 3.2f; // Make sure the spear moves forward when initially thrown out
					projectile.netUpdate = true; // Make sure to netUpdate this spear
				}
				if (projOwner.itemAnimation < projOwner.itemAnimationMax / 3.2f) // Somewhere along the item animation, make sure the spear moves back
				{
					movementFactor -= 3.2f;
				}
