...
{
	public class MightyWhipProj : ModProjectile
	{
		// chain texture
		private const string ChainTexturePath = "SummonWhips/Gores/MightyWhipChn";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Mighty Whip Projectile"); 
		}
		...
		public override void AI()
		{
			...
			if (projectile.ai[0] == 0f) {
				...
				float maxStretchLength = 122f; // make this number 6 less than max range
