...
namespace SummonWhips.Projectiles
{
    public class MeteorWhipProj : ModProjectile
    {
        ...
        public override void SetStaticDefaults() {
            DisplayName.SetDefault("Meteor Whip Projectile");
        }
        ...
        public override void AI() {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                Dust dust1 = Dust.NewDustPerfect(chainHeadPosition, 127, velocity, 150, Color.White, 1.5f);
            ...
            public override void OnHitNPC(NPC target, int damage, float knockback, bool crit)                
        {
            ...
            Projectile.NewProjectileDirect(target.Center, Vector2.Zero, ModContent.ProjectileType<MeteorExplosion>(), damage / 2, 1f, projectile.owner, 0f, 1f);
